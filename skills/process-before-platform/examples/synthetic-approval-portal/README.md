...
The completed questionnaire creates two aligned artifacts:
...
The JSON conforms to [schema version 2.0.0](../../schemas/initiative-request.schema.json). It is ready for another agent to parse or for a later field-mapping step into a known ticket system. It does not create a ticket.
